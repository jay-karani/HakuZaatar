...
public class blueTeleOp extends OpMode {
    ...
    @Override
    public void init() {
        RobotConstants.robotTeam = RobotConstants.RobotTeam.BLUE;
    ...
    @Override
    public void loop() {
        follower.setTeleOpDrive(-gamepad1.left_stick_y, -gamepad1.left_stick_x, -gamepad1.right_stick_x, false, Math.toRadians(180));
